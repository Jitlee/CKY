 ...
 * 商家控制器
 */
class GoodsPointsAction extends BaseAction{
	public function index(){
		$this->isLogin();
		//获取商品分类信息		
		$m = D('Admin/GoodsCats');
		$cats=$m->queryBykey('points');		
	...
	public function toEdit(){
		...
		//获取商品分类信息
		$m = D('Admin/GoodsCats');
		$this->assign('goodsCatsList',$m->queryBykey('points'));
