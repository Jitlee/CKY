...
<div class="rtc-body"> 
<div class='rtc-page-header'>卖家中心 > 评价管理</div>
   ...
   <table class='rtc-list' style="margin:0 auto;">
           ...
           <tbody>
            <?php if(is_array($Page['root'])): $k = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
               ...
               <td>
               	<div>商品评分：
               	<?php $__FOR_START_24831__=0;$__FOR_END_24831__=$vo['goodsScore'];for($i=$__FOR_START_24831__;$i < $__FOR_END_24831__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['goodsScore']); ?> 分
				</div>
				</td>
				<td>
				<div>时效评分：
               	<?php $__FOR_START_11980__=0;$__FOR_END_11980__=$vo['timeScore'];for($i=$__FOR_START_11980__;$i < $__FOR_END_11980__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['goodsScore']); ?> 分
				</div>
                </td>
                <td>
              	<div>服务评分：
               	<?php $__FOR_START_17685__=0;$__FOR_END_17685__=$vo['serviceScore'];for($i=$__FOR_START_17685__;$i < $__FOR_END_17685__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['goodsScore']); ?> 分
				</div>
               </td>
             </tr>
             <tr>
