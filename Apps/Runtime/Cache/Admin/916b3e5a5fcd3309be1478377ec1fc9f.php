...
<html>
    <head>
        ...
        <script>
	      $(function () {
	    	  $('#pageContent').height(RTC.pageHeight()-98);
	    	  getTask();
	      });
                ...
                <div class="navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="dropdown user user-menu">
                            <a href="<?php echo RTCDomain();?>" target='_blank'>
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span><?php echo session('RTC_STAFF.staffName');?>&nbsp;<i class="caret"></i></span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                                <li class="user-header bg-light-blue">
                                    <img src="/<?php echo session('RTC_STAFF.staffPhoto');?>" class="img-circle" alt="<?php echo session('RTC_STAFF.roleName');?>" />
                                    <p>
                                        <?php echo session('RTC_STAFF.staffName');?> - <?php echo session('RTC_STAFF.roleName');?>
                                        <small>职员编号：<?php echo ($RTC_STAFF["staffNo"]); ?></small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                ...
                <section class="sidebar">
                    ...
                    <div class="user-panel">
                        <div class="pull-left image">
                            <img src="/<?php echo session('RTC_STAFF.staffPhoto');?>" class="img-circle" alt="<?php echo session('RTC_STAFF.staffName');?>" />
                        </div>
                        <div class="pull-left info">
                            <p>Hello, <?php echo session('RTC_STAFF.staffName');?></p>
                        </div>
                    </div>
                    <!-- sidebar menu: : style can be found in sidebar.less -->
                    <ul class="sidebar-menu">
                        <?php if(in_array('spgl_00',$RTC_STAFF['grant'])){ ?>
                        <li class="treeview">
                            <a href="#">
                                <span>商品管理</span>
                        ...
                        <?php } ?>
                        <?php if(in_array('wzgl_00',$RTC_STAFF['grant'])){ ?>
                        <li class="treeview">
                            <a href="pages/mailbox.html">
                                <span> 文章管理</span>
                            </a>
                            <ul class="treeview-menu">
                               <?php if(in_array('wzlb_00',$RTC_STAFF['grant'])){ ?>
                               <li><a href="<?php echo U('Admin/Articles/index');?>" target='pageContent' >文章列表</a></li>
                               <?php } ?>
                               <?php if(in_array('wzfl_00',$RTC_STAFF['grant'])){ ?>
                        ...
                        <?php } ?>
                        <?php if(in_array('hygl_00',$RTC_STAFF['grant'])){ ?>
                        <li class="treeview">
                            <a href="#">
                                <span>会员管理</span>
                            </a>
                            <ul class="treeview-menu">
                                <?php if(in_array('hydj_00',$RTC_STAFF['grant'])){ ?>
                                <li><a href="<?php echo U('Admin/UserRanks/index');?>" target='pageContent' >会员等级</a></li>
                                <?php } ?>
                                <?php if(in_array('hylb_00',$RTC_STAFF['grant'])){ ?>
