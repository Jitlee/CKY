...
<style type="text/css">
.del {
	background: url('/Apps/Home/View/default/images/icon_edit_01.png') no-repeat;
}
...
<script>
    ...
    <div class="wst-body"> 
       <div class='wst-page-header'>卖家中心 > 商城消息 > 消息详情</div>
       <div class='wst-page-content'>  
	      <div class='wst-tbar-group'>
	          <a href="<?php echo U('Home/Messages/queryByPage');?>" class='back btn' style='float:right;padding-right:5px;'>返回</a>           
	      </div>  
          <div class="msgContent">            
            <?php echo ($info['msgContent']); ?>
          </div>
        </div>
    </div>
