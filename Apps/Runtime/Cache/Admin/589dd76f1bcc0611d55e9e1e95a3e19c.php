...
dl.areaSelect dd{ float: left; margin-left: 20px; cursor: pointer;}
   ...
   <body class="rtc-page" style="position:relative;">
		...
		<form id="uploadform_Filedata" autocomplete="off" style="<?php if($object[shopId] > 0): ?>top:204px;<?php else: ?>top:264px;<?php endif; ?>position:absolute;left:170px;z-index:10;" enctype="multipart/form-data" method="POST" target="upload" action="<?php echo U('Home/Shops/uploadPic');?>" >
			...
			<input id="shopImg" name="shopImg" class="form-control rtc-ipt" type="text" value="<?php echo ($object["shopImg"]); ?>" readonly style="margin-right:4px;float:left;margin-left:8px;width:250px;"/>
			<div class="div1">
       ...
       <form name="myform" method="post" id="myform" autocomplete="off">
        ...
        <table class="table table-hover table-striped table-bordered rtc-form">
           <?php if($object['shopId'] ==0 ): ?><tr>
             ...
             <td><input type='text' id='loginName' name='loginName' class="form-control rtc-ipt" value='<?php echo ($object["loginName"]); ?>' maxLength='25'/></td>
           </tr>
           <tr>
             <th align='right'>登录密码<font color='red'>*</font>：</th>
             <td><input type='password' id='loginPwd' class="form-control rtc-ipt" value='<?php echo ($object["loginPwd"]); ?>' maxLength='25'/></td>
           </tr><?php endif; ?>
           <tr>
             <th align='right'>店铺编号<font color='red'>*</font>：</th>
             <td><input type='text' id='shopSn' class="form-control rtc-ipt" value='<?php echo ($object["shopSn"]); ?>' maxLength='25'/></td>
           </tr>
           <tr>
             <th align='right'>店铺名称<font color='red'>*</font>：</th>
             <td><input type='text' id='shopName' class="form-control rtc-ipt" value='<?php echo ($object["shopName"]); ?>' maxLength='25'/></td>
           </tr>
           <tr>
             <th align='right'>店主姓名<font color='red'>*</font>：</th>
             <td><input type='text' id='userName' class="form-control rtc-ipt" value='<?php echo ($object["userName"]); ?>' maxLength='25'/></td>
           </tr>
           <tr>
             <th align='right'>店主联系手机<font color='red'>*</font>：</th>
             <td><input type='text' id='userPhone' name='userPhone' class="form-control rtc-ipt" value='<?php echo ($object["userPhone"]); ?>' maxLength='25'/></td>
           </tr>
           <tr>
             <th align='right'>公司名称<font color='red'>*</font>：</th>
             <td><input type='text' id='shopCompany' class="form-control rtc-ipt" value='<?php echo ($object["shopCompany"]); ?>' maxLength='25'/></td>
           </tr>
           <tr>
           ...
           <tr>
             ...
             <td><input type='text' id='shopAddress' class="form-control rtc-ipt" value='<?php echo ($object["shopAddress"]); ?>' maxLength='120'/></td>
           </tr>
           ...
           <tr>
             ...
             <td><input type='text' id='deliveryStartMoney' class="form-control rtc-ipt" value='<?php echo ($object["deliveryStartMoney"]); ?>' onkeypress="return RTC.isNumberdoteKey(event)" onkeyup="javascript:RTC.isChinese(this,1)" maxLength='25'/></td>
           </tr>
           <tr>
             <th align='right'>包邮起步价(元)<font color='red'>*</font>：</th>
             <td><input type='text' id='deliveryFreeMoney' class="form-control rtc-ipt" value='<?php echo ($object["deliveryFreeMoney"]); ?>' onkeypress="return RTC.isNumberdoteKey(event)" onkeyup="javascript:RTC.isChinese(this,1)" maxLength='25'/></td>
           </tr>
           <tr>
           ...
           <tr>
             ...
             <td><input type='text' id='deliveryCostTime' class="form-control rtc-ipt" value='<?php echo ($object["deliveryCostTime"]); ?>' onkeypress="return RTC.isNumberKey(event)" onkeyup="javascript:RTC.isChinese(this,1)" maxLength='25'/></td>
           </tr>
           <tr>
           ...
           <tr>
             ...
             <td><input type='text' id='bankNo' class="form-control rtc-ipt" value='<?php echo ($object["bankNo"]); ?>' maxLength='25'/></td>
           </tr>
           <tr>
           ...
           <tr id='invoiceRemarkstr' <?php if($object['isInvoice'] == 0 ): ?>style='display:none'<?php endif; ?>>
             ...
             <td><input type='text' id='invoiceRemarks' class="form-control rtc-ipt" value='<?php echo ($object["invoiceRemarks"]); ?>' maxLength='25'/></td>
           </tr>
           <tr>
           ...
           <tr id="refuseMsg" <?php if($object['shopStatus'] > -1 ): ?>style='display:none'<?php endif; ?>>
           	 <th>拒绝理由：</th>
           	 <td>
           	 	<input class="form-control rtc-ipt" type="text" id="statusRemarks" name="statusRemarks" length="255" value="<?php echo ($object['statusRemarks']); ?>">
           	 </td>
           </tr>
           <tr>
