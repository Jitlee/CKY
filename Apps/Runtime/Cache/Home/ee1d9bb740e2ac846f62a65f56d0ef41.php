...
<html lang="zh-cn">
	<head>
     	...
     	<link rel="stylesheet" href="/Apps/Home/View/default/css/shopstreet.css" />
	    ...
	    <div>
			<div class="wst-street-ad-box">
				<?php if(is_array($ads)): $i = 0; $__LIST__ = $ads;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($i == 1): ?><a href="<?php echo U('Home/Index/access/',array('url'=>$vo['adURL']));?>" target="_blank">
						<img src="/<?php echo ($vo['adFile']); ?>" width='1210' height="350" title="<?php echo ($vo['adName']); ?>"/>
                        ...
                        <div class="wst-shop-box">
                           <div style="width:80px;height:80px; float:left;">
                               <a href="{{ Think.U('Home/Shops/toShopHome','shopId='+d[i].shopId)}}">
                                 <img width="80" class='lazyImg' height="80" title="{{d[i].shopName}}" data-original="/{{d[i].shopImg}}" src="/<?php echo ($CONF['goodsImg']); ?>" style="display: inline;">
                               </a>
                           </div>
                           <div class="wst-shop-streets-items">
                               ...
                               <div class="wst-shop-streets-items-status">
                                  <img style="vertical-align:middle" src="/Apps/Home/View/default/images/icon_menu_01.png">&nbsp;&nbsp;
