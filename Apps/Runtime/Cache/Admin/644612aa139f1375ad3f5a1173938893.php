       ...
       <form name="myform" method="post" id="myform">
        ...
        <table class="table table-hover table-striped table-bordered rtc-form">
           <tr>
             ...
             <td><input type='text' id='payName' class="form-control rtc-ipt" value='<?php echo ($object["payName"]); ?>' maxLength='50'/></td>
           </tr>
           <tr>
           ...
           <tr>
             ...
             <td><input type='text' id='payOrder' class="form-control rtc-ipt" value='<?php echo ($object["payOrder"]); ?>' maxLength='50'/></td>
           </tr>
           <tr>
