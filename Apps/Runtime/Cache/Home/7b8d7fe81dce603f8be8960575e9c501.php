...
var filetypes = ["gif","jpg","png","jpeg"];
       ...
       <div class='wst-page-content' style="position:relative;">
			...
			<form id="uploadform_Filedata" autocomplete="off" style="position:absolute;left:388px;z-index:10;" enctype="multipart/form-data" method="POST" target="upload" action="<?php echo U('Home/Shops/uploadPic');?>" >
				<div id="preview_Filedata" >
             	<img id='preview' src='<?php if($user['userPhoto'] =='' ): ?>/<?php echo ($CONF['goodsImg']); else: ?>/<?php echo ($user["userPhoto"]); endif; ?>' height='150' />
                </div>
