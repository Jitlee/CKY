   ...
   <table class='wst-list' style="margin:0 auto;">
           ...
           <tbody>
            <?php if(is_array($Page['root'])): $k = 0; $__LIST__ = $Page['root'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
               ...
               <td>
               	<div>商品评分：
               	<?php $__FOR_START_20771__=0;$__FOR_END_20771__=$vo['goodsScore'];for($i=$__FOR_START_20771__;$i < $__FOR_END_20771__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['goodsScore']); ?> 分
				</div>
				</td>
				<td>
				<div>时效评分：
               	<?php $__FOR_START_26144__=0;$__FOR_END_26144__=$vo['timeScore'];for($i=$__FOR_START_26144__;$i < $__FOR_END_26144__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['goodsScore']); ?> 分
				</div>
                </td>
                <td>
              	<div>服务评分：
               	<?php $__FOR_START_27609__=0;$__FOR_END_27609__=$vo['serviceScore'];for($i=$__FOR_START_27609__;$i < $__FOR_END_27609__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>&nbsp;<?php echo ($vo['goodsScore']); ?> 分
				</div>
               </td>
             </tr>
             <tr>
