       ...
       <form name="myform" method="post" id="myform" autocomplete="off">
        ...
        <table class="table table-hover table-striped table-bordered rtc-form">
           <tr>
             ...
             <td><input type='text' id='catName' class="form-control rtc-ipt" value='<?php echo ($object["catName"]); ?>' maxLength='25'/></td>
           </tr>
           <tr>
           ...
           <tr>
             ...
             <td><input type='text' id='catSort' class="form-control rtc-ipt" value='<?php echo ($object["catSort"]); ?>' style='width:80px' onkeypress="return RTC.isNumberKey(event)" onkeyup="javascript:RTC.isChinese(this,1)" maxLength='8'/></td>
           </tr>
           <tr>
