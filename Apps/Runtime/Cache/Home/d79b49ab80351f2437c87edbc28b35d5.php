			...
			<tbody>
				<tr>
					...
					<td width="280" style="vertical-align:top;line-height:25px;">
						...
						<div style="">商品描述:
							<?php $__FOR_START_27797__=0;$__FOR_END_27797__=$shopInfo['details']['goodsScore'];for($i=$__FOR_START_27797__;$i < $__FOR_END_27797__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>
							<?php echo ($shopInfo['details']['goodsScore']); ?>分
						</div>
						<div style="">时效评分:
							<?php $__FOR_START_20906__=0;$__FOR_END_20906__=$shopInfo['details']['timeScore'];for($i=$__FOR_START_20906__;$i < $__FOR_END_20906__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>
							<?php echo ($shopInfo['details']['timeScore']); ?>分
						</div>
						<div style="">服务评分:
							<?php $__FOR_START_16795__=0;$__FOR_END_16795__=$shopInfo['details']['serviceScore'];for($i=$__FOR_START_16795__;$i < $__FOR_END_16795__;$i+=1){ ?><img src="/Apps/Home/View/default/images/icon_score_yes.png"/><?php } ?>
