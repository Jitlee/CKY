       ...
       <form name="myform" method="post" id="myform" autocomplete="off">
        ...
        <table class="table table-hover table-striped table-bordered rtc-form">
           <tr>
             ...
             <td><input type='text' id='articleTitle' class="form-control rtc-ipt" value='<?php echo ($object["articleTitle"]); ?>' maxLength='25'/></td>
           </tr>
           <tr>
           ...
           <tr>
             ...
             <td>
             <input type='text' id='articleKey' class="form-control rtc-ipt" value='<?php echo ($object["articleKey"]); ?>' maxLength='80'/>
             </td>
           </tr>
           <tr>
