...
<div id="rtc-shortcut">
	...
	<div class="rtc-body" style="margin-bottom: 8px;"> 
		<div class='rtc-page-header'>卖家中心 > 订单管理</div>
		<div class='rtc-page-content' style="padding-top:10px;">
		   <div id='tab' class="rtc-tab-box">
			<ul class="rtc-tab-nav">
				<li id="rtc-msg-li-0">待受理订单<span style="display:none;" class="rtc-order-tips-box"></span></li>
				<li id="rtc-msg-li-1">已受理订单<span style="display:none;"></span></li>
				<li id="rtc-msg-li-2">打包中订单<span style="display:none;"></span></li>
				<li id="rtc-msg-li-3">配送中订单<span style="display:none;"></span></li>
				<li id="rtc-msg-li-4">已到货订单<span style="display:none;" class="rtc-order-tips-box"></span></li>
				<li id="rtc-msg-li-5">取消 / 拒收订单<span style="display:none;" class="rtc-order-tips-box"></span></li>
			</ul>
						...
						<table class='rtc-list' style="font-size:13px;">
							<thead>
								<tr>
									...
									<button class='rtc-btn-query' onclick="queryOrderPager(0,0)">查询</button>
									<button class='rtc-btn-query' style='width:80px;' onclick="batchShopOrderAccept()">批量受理</button>
									</th>
								</tr>
								<tr>
								    <th width='20'><input type='checkbox' onclick='RTC.checkChks(this,".chk_0")'/></th>
									<th width='100'>订单号</th>
									<th width='100'>收货人</th>
									<th width='*'>收货地址</th>
									<th width='70'>订单金额</th>
							...
							<tfoot>
								<tr>
									<td colspan='8' align='center' id="opage_0">
										<div id="rtc-page-0" class='rtc-page' style="float:right;padding-bottom:10px;"></div>
									</td>
								</tr>
							 </tfoot>
						</table>
						...
						<table class='rtc-list' style="font-size:13px;">
							<thead>
								<tr>
									...
									<button class='rtc-btn-query' onclick="queryOrderPager(1,0)">查询</button>
									<button class='rtc-btn-query' style='width:80px;' onclick="batchShopOrderProduce()">批量打包</button>
									</th>
								</tr>
								<tr>
								    <th width='20'><input type='checkbox' onclick='RTC.checkChks(this,".chk_1")'/></th>
									<th width='100'>订单号</th>
									<th width='100'>收货人</th>
									<th width='*'>收货地址</th>
									<th width='70'>订单金额</th>
							...
							<tfoot>
								<tr>
									<td colspan='8' align='center' id="opage_1">
										<div  id="rtc-page-1" class="rtc-page" style="float:right;padding-bottom:10px;"></div>
									</td>
								</tr>
							 </tfoot>
						</table>
						...
						<table class='rtc-list' style="font-size:13px;">
							<thead>
								<tr>
									...
									<button class='rtc-btn-query' onclick="queryOrderPager(2,0)">查询</button>
									<button class='rtc-btn-query' style='width:80px;' onclick="batchShopOrderDelivery()">批量配送</button>
									</th>
								</tr>
								<tr>
								    <th width='20'><input type='checkbox' onclick='RTC.checkChks(this,".chk_2")'/></th>
									<th width='100'>订单号</th>
									<th width='100'>收货人</th>
									<th width='*'>收货地址</th>
									<th width='70'>订单金额</th>
							...
							<tfoot>
								<tr>
									<td colspan='8' align='center' id="opage_2">
										<div  id="rtc-page-2" class="rtc-page" style="float:right;padding-bottom:10px;"></div>
									</td>
								</tr>
							 </tfoot>
						</table>
						...
						<table class='rtc-list' style="font-size:13px;">
							<thead>
								<tr>
									...
									<button class='rtc-btn-query' onclick="queryOrderPager(3,0)">查询</button>
									</th>
								</tr>
								<tr>
									<th width='100'>订单号</th>
							...
							<tfoot>
								<tr>
									<td colspan='8' align='center' id="opage_3">
										<div  id="rtc-page-3" class="rtc-page" style="float:right;padding-bottom:10px;"></div>
									</td>
								</tr>
							 </tfoot>
						</table>
						...
						<table class='rtc-list' style="font-size:13px;">
							<thead>
								<tr>
									...
									<button class='rtc-btn-query' onclick="queryOrderPager(4,0)">查询</button>
									</th>
								</tr>
								<tr>
									<th width='100'>订单号</th>
							...
							<tfoot>
								<tr>
									<td colspan='8' align='center' id="opage_4">
										<div  id="rtc-page-4" class="rtc-page" style="float:right;padding-bottom:10px;"></div>
									</td>
								</tr>
							 </tfoot>
						</table>
						...
						<table class='rtc-list' style="font-size:13px;">
							<thead>
								<tr>
									...
									<button class='rtc-btn-query' onclick="queryOrderPager(5,0)">查询</button>
									</th>
								</tr>
								<tr>
									<th width='100'>订单号</th>
							...
							<tfoot>
								<tr>
									<td colspan='8' align='center' id="opage_5">
										<div  id="rtc-page-5" class="rtc-page" style="float:right;padding-bottom:10px;"></div>
									</td>
								</tr>
							 </tfoot>
						</table>
